...
| 6 | 《Efficient Memory Management for LLM Serving with PagedAttention》（vLLM 论文，SOSP'23） | Kwon et al., UC Berkeley | 🛠️实践 | 看它是为了懂所有现代引擎的显存管理核心：KV 分页如何把碎片打到近零 | 推理优化, KV Cache | ✅ 已下载 `../../_reference/ebooks/arXiv-2309.06180-vLLM-PagedAttention.pdf` |
| 7 | 《Mooncake: A KVCache-centric Disaggregated Architecture for LLM Serving》（FAST'25 最佳论文） | 月之暗面 Kimi | 🛠️实践 | 生产级 P/D 分离的真实复盘：Kimi 线上集群怎么用 KVCache 为中心的架构扛流量，讲成本账最有说服力 | P/D 分离, 分布式推理 | ✅ 已下载 `../../_reference/ebooks/arXiv-2407.00079-Mooncake-KVCache-Disaggregation.pdf` |
...
| 10 | 《Taming the Titans: A Survey of Efficient LLM Inference Serving》 | Zhen et al. | 📖理论·可选读 | 想系统盘点实例级/集群级全部优化方向再看，偏学术综述 | 推理优化全景 | ✅ 已下载 `../../_reference/ebooks/arXiv-2504.19720-Taming-Titans-Inference-Serving-Survey.pdf` |
