...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | 《动手学深度学习》（中文版·PyTorch）注意力机制章 | 阿斯顿·张、李沐等 / d2l.ai | 🛠️实践 | 中文教材+可运行代码，从零实现缩放点积注意力、多头注意力和 Transformer，动手入门首选 | 注意力机制, Transformer 实现 | 🔗 官方免费下载：https://zh.d2l.ai/（第 10、11 章） |
...
| 8 | DeepSeek-V2 技术报告（MLA 出处） | DeepSeek-AI | 🛠️实践 | 看它是为了答"DeepSeek 为什么便宜"：MLA 如何把 KV 缓存压到约 1/10，工程动机写得很直白 | MLA, KV 缓存优化, MoE | 🔗 官方免费下载：https://arxiv.org/abs/2405.04434 |
| 9 | Attention Is All You Need | Vaswani 等 / Google | 📖理论·可选读 | 一切的源头；不必通读，看架构图（图 1）与 3.2 节缩放点积注意力即可，想深入再全文 | Transformer 原始架构 | 🔗 官方免费下载：https://arxiv.org/abs/1706.03762 |
